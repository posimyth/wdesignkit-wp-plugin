...
import { Toast_message, Wkit_mobile_header, wdKit_Form_data } from '../helper/helper-function';
...
import Main_activate_container from './redux/redux_container/main_activate_container';
...
const WDesignKit = (props) => {
    ...
    const Set_metaData = async () => {
        ...
        if (login) {
            ...
            let form_array = { 'type': 'wkit_meta_data', 'meta_type': 'all' }
            var res = await form_data(form_array).then((res) => { return res });
                    ...
                    <Routes>
                        ...
                        {window.wdkit_editor == 'wdkit' &&
                            <Fragment>
                                ...
                                {/* <Route path='/activate' element={<Main_activate_container />} /> */}
