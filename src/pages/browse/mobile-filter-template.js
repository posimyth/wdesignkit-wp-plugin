            ...
            <Fragment>
                <div className='wkit-category-mobile-filter'>
                    <div className='wkit-custom-category-wrap'>
                        ...
                        />
                        <label className='wkit-check-wrapper' htmlFor='wkit-free-btn-label-mb'>{__('Free', 'wdesignkit')}</label>
                    </div>
                    <div className='wkit-custom-category-wrap'>
                        <input
                            type="checkbox"
                        ...
                        />
                        <label className='wkit-check-wrapper' htmlFor='wkit-pro-btn-label-mb'>{__('Pro', 'wdesignkit')}</label>
                    </div>
                </div>
            </Fragment>
        );
    ...
    return (
        <div className="wkit-mobile-filter-main">
            <div className='wkit-mobile-filter-main-content'>
                ...
                <div className="wkit-filter-by-page-builder">
                    <div className="wkit-browse-filter-heading">{__('Type :', 'wdesignkit')}</div>
                    {PageTypeFilter()}
                </div>
                <div className="wkit-filter-by-page-builder">
                    <div className="wkit-browse-filter-heading">{__('Plugins :', 'wdesignkit')}</div>
                    {PluginFilter()}
                </div>
                ...
                <div className="wkit-filter-by-categorties">
                    <div className="wkit-browse-filter-heading">{__('Tag :', 'wdesignkit')}</div>
                    {TagFilter()}
                </div>
            </div>
