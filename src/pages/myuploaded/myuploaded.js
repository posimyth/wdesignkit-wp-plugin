...
import { Wkit_availble_not, Wkit_template_Skeleton } from "../../helper/helper-function";
        ...
        <div className="wkit-myupload-main">
            ...
            <div className="wdkit-loop">
                ...
                {loading == false && listLength <= 0 &&
                    <Wkit_availble_not page={'template'} />
                }
            </div>
