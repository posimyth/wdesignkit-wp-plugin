...
const { wkit_logout } = wp.wkit_Helper;
                    ...
                    <div className="wdkit-inner-right-side-menu">
                        ...
                        {get_user_login() ?
                            <div className="wkit-login-signup-with-notify">
                                <div className="wkit-user-profile-cover">
                                    ...
                                    <div className="wkit-user-dropdown-new">
                                        <div className="wkit-user-dropdown-inner">
                                                ...
                                                <ul className="wkit-user-dropdown-link-inner">
                                                    <li className="wkit-user-dropdown-link">
                                                        <a href="https://wdesignkit.com/admin/dashboard" target="_blank" className="wkit-user-server-links">
                                                            ...
                                                            <span className="wkit-user-link-name">Dashboard</span>
                                                        </a>
                                                    </li>
                                                    {/* <li className="wkit-user-dropdown-link">
                                                    <span target="_blank" className="wkit-user-server-links wkit-user-server-links-disable">
                                                        <span>
                                                            <svg width="24" height="26" viewBox="0 0 24 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                <path d="M12.7627 7.66286H14.6689L15.9736 2.40245C16.0856 1.95166 15.7444 1.51562 15.2797 1.51562H11.9526C11.558 1.51562 11.2378 1.83583 11.2378 2.23042V4.24422M14.6684 10.3325L16.6638 12.6129C18.8181 15.0751 20.0056 18.2354 20.0056 21.507C20.0056 23.1543 18.6681 24.4855 17.027 24.4855H6.97267C5.32262 24.4855 3.99414 23.146 3.99414 21.507C3.99414 18.333 5.11816 15.1475 7.33591 12.6129L9.33123 10.3325M10.6665 19.7187C11.1659 20.0454 11.4317 20.0815 12.0002 20.0777C13.4571 20.068 13.9865 18.0482 12.5543 17.542C11.9144 17.3158 11.4396 17.1123 11.1241 16.8648C10.5745 16.4338 10.7753 15.3272 11.584 15.0836C11.7319 15.039 11.8711 15.0168 12.0003 15.0107C12.0003 15.0107 12.6002 14.9753 13.0362 15.3453M12.001 20.6231V20.0781M12.001 14.5234V15.0111M19.2431 6.51953C18.0879 6.51953 17.0128 7.16805 16.4846 8.22442L16.1934 8.80689L16.8958 9.33372C17.4297 9.73413 18.079 9.95055 18.7463 9.95055H19.2431M14.8598 10.3307H9.14143C8.4045 10.3307 7.80713 9.73333 7.80713 8.99641C7.80713 8.26155 8.40249 7.66211 9.14143 7.66211H14.8598C15.5967 7.66211 16.1941 8.25948 16.1941 8.99641C16.1941 9.73131 15.5987 10.3307 14.8598 10.3307ZM12.7631 7.66393L11.7823 4.72168C11.685 4.42979 11.4119 4.23291 11.1043 4.23291H9.18018C8.6923 4.23291 8.34777 4.71089 8.50208 5.17374L9.33215 7.66393H12.7631Z" stroke="#020202" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
                                                            </svg>
                                                        </span>
                                                        <span className="wkit-user-link-name">Earn Free Credits</span> <span className="wkit-nav-hint-text">Coming Soon</span>
                                                    ...
                                                    <li className="wkit-user-dropdown-link">
                                                        <a href="https://wdesignkit.com/admin/profile" target="_blank" className="wkit-user-server-links">
                                                            ...
                                                            <span className="wkit-user-link-name">Manage Profile</span>
                                                        </a>
                                                    </li>
                                                </ul>
                                                <button className="wkit-user-logout-link-btn" onClick={(e) => { wkit_logout_User(navigation) }}>
                                                    <span className="wkit-logout-user">Logout</span>
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div className="wdkit-login-signUp-btn-cover">
                                <Link to="/login" className="wdkit-tertiaty-btn">Login</Link>
                                <a href={wdkitData.wdkit_server_url} className="wkit-pink-btn-class wkit-get-started-btn">Get Started</a>
                            </div>
                        }
