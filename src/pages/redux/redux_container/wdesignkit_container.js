...
import { Change_wdkit_meta, Change_wdkit_mainData, ChangePanelSettings, ShowToast } from '../redux_data/store_action';
...
const maptowdesignkit = dispatch => ({
    ...
    // wdkit_set_mainData: data => dispatch(Change_wdkit_mainData(data))
})
