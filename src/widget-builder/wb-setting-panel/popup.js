...
const Pop_up = (props) => {
    ...
    const handleImage = (e, type) => {
        if (type == 'upload') {
            ...
            let background_div = e.target.closest('.drop-zone');
        ...
        <>
            <div className='wkit-wb-info-popup' ref={closePopup} onClick={(e) => { Close_popup(e) }}>
                <div className="wkit-wb-header-popup">
                    <h2 className='wkit-wb-popup-hreader'>{__('Edit Widget Information', 'wdesignkit')}</h2>
                        ...
                        <div className='wkit-wb-block-detail' >
                            <div className='wkit-wb-block-wrapper'>
                                <div className='wkit-wb-block-name'>
                                    <div className='wkit-wb-keyWord-title'>
                                        <label className="wkit-wb-block-label">{__('Name', 'wdesignkit')}</label>
                                        <div className='wkit-wb-toolTip wkit-popup-first-toolTip'>
                                            ...
                                            <span className='wkit-wb-toolTip-text wb-wkit-widgetName-toolTip wkit-wb-name-Tooltip'>{__('Only numbers and alphabet are allowed for this field, Widget name must be smaller then 25 charaters and first letter can\'t be digit.', 'wdesignkit')}</span>
                                        </div>
                                    </div>
                                    <input
                                        ...
                                        type='text'
                                        ref={nameValidation}
                                        placeholder={__('Enter your Widget Name', 'wdesignkit')}
                                        onChange={(e) => { Name_Validation(e) }}
                                    />
                                </div>
                                <div className='wkit-wb-block-category'>
                                    <div className='wkit-wb-keyWord-title'>
                                        <label className="wkit-wb-block-label">{__('Category', 'wdesignkit')}</label>
                                    </div>
                                    ...
                                    <div className='wkit-wb-custom-category' style={{ display: Custom_category }}>
                                        <div className='wkit-wb-custom-category-header'>
                                            <div className='wkit-wb-keyWord-title'>
                                                <span className='wkit-wb-custom-category-name'>{__('Create New Category', 'wdesignkit')}</span>
                                                <div className='wkit-wb-toolTip' style={{ top: '1px' }}>
                                                    ...
                                                    <span className='wkit-wb-toolTip-text wb-wkit-widgetCategory-toolTip'>{__('Add more categories of Elementor Editor area.', 'wdesignkit')}</span>
                                                </div>
                                            </div>
                            ...
                            <div className='wkit-wb-block-feature-img' >
                                <div className='wkit-wb-upload-block-icon'>
                                    <div className='wkit-wb-keyWord-title'>
                                        <label className="wkit-wb-block-label">{__('Featured Image', 'wdesignkit')}</label>
                                        <div className='wkit-wb-toolTip'>
                                            <img className="wkit-wb-toolTip-icon" src={img_path + 'assets/images/wb-svg/info.svg'} width="13" />
                                            <span className='wkit-wb-toolTip-text'>{__('Only .jpg and .png are allowed', 'wdesignkit')}</span>
                                        </div>
                                    </div>
                                    <div className="drop-zone"
                                        ...
                                        {!widget_image ?
                                            <div className='drop-zone__prompt'>
                                                ...
                                                <div className='wkit-wb-drag-drop-label'>{__('Upload Widget\'s featured image to show in widget listing. Only .jpg and .png images allowed.', 'wdesignkit')}</div>
                                            </div>
                                            :
                                ...
                                <div className='wkit-wb-upload-block-icon'>
                                    <div className='wkit-wb-keyWord-title'>
                                        <label className="wkit-wb-block-label">{__('Icon', 'wdesignkit')}</label>
                                        <div className='wkit-wb-toolTip'>
                                            <img className="wkit-wb-toolTip-icon" src={img_path + 'assets/images/wb-svg/info.svg'} width="13" />
                                            <span className='wkit-wb-toolTip-text wb-wkit-widgetIcon-toolTip'>{__('Choose and paste your icon code here to show that with widget.', 'wdesignkit')}</span>
                                        </div>
                                    </div>
                                    <div className="wb-eicons-content">
                                        ...
                                        <div className="wb-eicons-links">
                                            <div className="wb-eicons-links-heading">
                                                <span>{__('Copy and Paste Icons from below libraries', 'wdesignkit')}</span>
                                            </div>
                            ...
                            <div className='wkit-wb-widget-info'>
                                <div className='wkit-wb-key-words'>
                                    <div className='wkit-wb-keyWord-title'>
                                        <label className="wkit-wb-input-lable">{__('Keywords', 'wdesignkit')}</label>
                                        <div className='wkit-wb-toolTip'>
                                            <img className="wkit-wb-toolTip-icon" src={img_path + 'assets/images/wb-svg/info.svg'} width="13" />
                                            <span className='wkit-wb-toolTip-text wb-wkit-widgetkeyW-toolTip'>{__('Enter keywords to allow searching in elementor editor.', 'wdesignkit')} <a href='https://developers.elementor.com/docs/widgets/widget-data/' target='_blank' rel="noopener noreferrer">{__('Read More', 'wdesignkit')}</a></span>
                                        </div>
                                    </div>
                                ...
                                <div className='wkit-wb-helper-link'>
                                    <div className='wkit-wb-keyWord-title'>
                                        <label className="wkit-wb-input-lable">{__('Help Link', 'wdesignkit')}</label>
                                        <div className='wkit-wb-toolTip'>
                                            <img className="wkit-wb-toolTip-icon" src={img_path + 'assets/images/wb-svg/info.svg'} width="13" />
                                            <span className='wkit-wb-toolTip-text wb-wkit-widgetHelper-toolTip'>{__('Enter URL for users to get more information about this widget.', 'wdesignkit')} <a href='https://developers.elementor.com/docs/widgets/widget-data/' target='_blank' rel="noopener noreferrer">{__('Read More', 'wdesignkit')}</a></span>
                                        </div>
                                    </div>
                            ...
                            <div className='wkit-wp-btn-center wb-add-widget-footer'>
                                <div className="wb-add-widget-cancelBtn">
                                    <button onClick={(e) => { props.Close_popup(); }} > {__('Cancel', 'wdesignkit')} </button>
                                </div>
                                <div
                                    className="wkit-wb-block-btn-save"
                                    onClick={(e) => { setCustom_category('none'); if (name !== "" && isNaN(name.charAt(0))) { Save_data() } }} >
                                    <a className='wkit-wb-save-btn'>{__('SAVE', 'wdesignkit')}</a>
                                </div>
                            </div>
                        </div>
                    </div>
